...
export default function JanvierPage() {
  const data = januaryData;
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        <div className="bg-white rounded-2xl shadow-2xl p-6 border border-gray-100">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Janvier à Maurice en résumé</h2>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-3xl font-bold text-gray-900 mb-8">Quelle météo à l'Île Maurice en janvier ?</h2>
      ...
      {/* Budget Section */}
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-3xl font-bold text-gray-900 mb-8">Affluence et budget pour janvier</h2>
      ...
      <div className="bg-gray-50 py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Que faire à l'Île Maurice en janvier ?</h2>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-3xl font-bold text-gray-900 mb-8">Où loger à l'Île Maurice en janvier ?</h2>
      ...
      <div className="bg-gray-50 py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Conseils pratiques pour janvier</h2>
      ...
      {/* FAQ Section */}
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-3xl font-bold text-gray-900 mb-8">Questions fréquentes sur janvier à Maurice</h2>
      ...
      <div className="bg-gradient-to-br from-blue-600 to-cyan-500 text-white py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-6">Notre verdict final : faut-il partir en janvier ?</h2>
          <p className="text-xl text-white/95 mb-8">{data.verdict.summary}</p>

          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              <h3 className="font-bold text-white mb-4 flex items-center gap-2">
                <span className="text-xl">✓</span> Partez en janvier si :
              </h3>
              <ul className="space-y-2">
